...
// dynamically build data-filter buttons for each type of datapoint
    ...
    function buttonClick(datapoint) {
      // use one of the default discrete color scheme categories to show
      // the team's conference alignment as well size to show their rank in given category
      ...
      var tenColorScale = d3.scaleOrdinal()
                            ...
                            .unknown("#c4b9ac")  // if they're not in a conf, neutral color
