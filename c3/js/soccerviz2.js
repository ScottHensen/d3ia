...
// dynamically build data-filter buttons for each type of datapoint
    ...
    function buttonClick(datapoint) {
      // resize the circles based on their standings for the chosen data point
      ...
      // range colors from yellow to blue as you go down the scale
        // the interpolation sucks in rgb.  you get yellow, yuck and blue.
        // var ybRamp = d3.scaleLinear()
        //                .domain([0,maxValue]).range(["blue", "yellow"])
        // the interpolation in hsl is a nice yellow-green-blue gradation.
        var ybRamp = d3.scaleLinear()
