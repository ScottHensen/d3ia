...
// add team flag images
    d3.selectAll("g.overallG").insert("image", "text")  // insert instead of append
      .attr("xlink:href", d => `img/${d.team}.png`)     // so that image lays down before text
      .attr("width", "45px")
      .attr("height", "20px")
      .attr("x", -22).attr("y", -10)                    // manually center it
